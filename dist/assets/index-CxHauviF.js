const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/Dashboard-B_XtB_WB.js","assets/Dashboard-BnsTFbab.css"])))=>i.map(i=>d[i]);
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class _w{constructor(e){this.container=e}getPlatformInfoString(){return this.container.getProviders().map(n=>{if(yw(n)){const r=n.getImmediate();return`${r.library}/${r.version}`}else return null}).filter(n=>n).join(" ")}}function yw(t){const e=t.getComponent();return(e==null?void 0:e.type)==="VERSION"}const Nc="@firebase/app",_d="0.10.6";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function rT(t){rs(new Ir("platform-logger",e=>new _w(e),"PRIVATE")),rs(new Ir("heartbeat",e=>new eT(e),"PRIVATE")),Kn(Nc,_d,t),Kn(Nc,_d,"esm2017"),Kn("fire-js","")}rT("");var sT="firebase",iT="10.12.3";/**
 * @license
